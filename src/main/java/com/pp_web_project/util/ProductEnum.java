...
public enum ProductEnum {
    ...
    KR_MAX_3D("8809365670673", "한국 MAX 3일"),
    KR_MAX_5D("8809365670680", "한국 MAX 5일"),
    KR_MAX_7D("8809365670697", "한국 MAX 7일"),
    KR_MAX_10D("8809365670703", "한국 MAX 10일"),
    KR_MAX_15D("8809365670710", "한국 MAX 15일"),
    KR_MAX_20D("8809365670727", "한국 MAX 20일"),
    SKT_2D("8809365670611", "SKT 2일"),
    SKT_3D("8809365670529", "SKT 3일"),
    SKT_4D("8809365670628", "SKT 4일"),
    SKT_5D("8809365670536", "SKT 5일"),
    SKT_6D("8809365670635", "SKT 6일"),
    SKT_7D("8809365670543", "SKT 7일"),
    SKT_8D("8809365670642", "SKT 8일"),
    SKT_9D("8809365670659", "SKT 9일"),
